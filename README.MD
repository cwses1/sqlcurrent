SQL Current is database migrations scripting engine written in Python.  It works with any database that has a Python driver.  A very simple script looks like this:
