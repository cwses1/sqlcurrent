class MessageBuilder ():
	...
	def createSpecifiedVersionNotFoundMessage (branchName:str, specifiedVersionNumber:str) -> str:
		message = 'ERROR: Version \'{}\' for branch \'{}\' not defined.\n'.format(specifiedVersionNumber, branchName)
		return message
	...
	@staticmethod
	def createCurrentVersionEqualToSpecifiedVersionMessage (branchName:str, currentVersionNumber:str) -> str:
		message = 'The specified version \'{}\' for branch \'{}\' is the same as the current version number \'{}\'.  There is nothing to update.'.format(branchName, currentVersionNumber, currentVersionNumber)
		return message

	@staticmethod
	def createSpecifiedVersionLessThanCurrentVersionMessage (branchName:str, specifiedVersionNumber:str, currentVersionNumber:str) -> str:
		message = 'ERROR: The specified version \'{}\' for branch \'{}\' is lower than the current version number \'{}\'.\n'.format(specifiedVersionNumber, branchName, currentVersionNumber)
		message += ' * When specifying a version, you cannot use the update statement to revert to a previous version.\n'
		message += ' * You must use the revert statement if you want to revert to a previous version.\n'
		return message
