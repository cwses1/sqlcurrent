...
class ScriptFilePathFactory ():
	...
	def createPath (self, pathParam:str) -> str:
		...
		if self.createDir != None:
			return self.sqlScriptsDir + os.sep + self.branchName + os.sep + self.createDir + os.sep + pathParam
	...
	def createCreatePathForStandaloneDatabase (self, pathParam:str) -> str:
		...
		return self.sqlScriptsDir + os.sep + self.databaseName + os.sep + 'create' + os.sep + pathParam
	...
	def createResetPath (self, pathParam:str) -> str:
		...
		return self.sqlScriptsDir + os.sep + self.branchName + os.sep + self.databaseName + os.sep + self.resetDir + os.sep + pathParam
	...
	def createResetPathForStandaloneDatabase (self, pathParam:str) -> str:
		...
		# IN THIS METHOD WE IGNORE THE BRANCH.
		#
		return self.sqlScriptsDir + os.sep + self.databaseName + os.sep + self.resetDir + os.sep + pathParam
