...
class CheckServerAppService ():
	...
	def run (self):
		...
		print('{0}: Checking server.'.format(serverSymbolName))
		...
		scriptRunnerService.runServerCheckScripts()

		print('{}: Check server complete.'.format(serverSymbolName))
