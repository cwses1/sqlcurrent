...
from .PrecheckConfigAppService import *

class PrecheckConfigListAppService ():
	...
	def run (self) -> ScriptRunnerResultSet:
		return self.runForDatabases() if self.targetSymbolType == SymbolType.Database else self.runForServers()

	def runForDatabases (self) -> ScriptRunnerResultSet:
