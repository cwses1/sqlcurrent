...
class ResetServerAppService ():
	...
	def run (self):
		...
		print('{0}: Resetting server.'.format(serverSymbolName))
		...
		scriptRunnerService.runServerResetScripts()

		print('{}: Reset server complete.'.format(serverSymbolName))
